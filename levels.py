...
class Levels:
    def __init__(self):
        ...
        level_1 = level.Level([('foxy', 'asleep')], ['catnip_gate'], 1)
        level_2 = level.Level([('miso', 'idle'), ('miso', 'idle')], ['catnip_gate', 'catnip_gate'], 1)
        ...
        level_5 = level.Level([('miso', 'idle')], ['catnip_gate'], 2)
        level_6 = level.Level([('foxy', 'idle')], ['catnip_gate'], 3)
        level_7 = level.Level([('cookie', 'idle')], ['catnip_gate'], 4)
        level_8 = level.Level([('peanut', 'idle')], ['catnip_gate'], 5)
